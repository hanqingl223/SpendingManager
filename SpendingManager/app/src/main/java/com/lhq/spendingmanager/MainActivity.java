package com.lhq.spendingmanager;
...
public class MainActivity extends AppCompatActivity {
    ...
    double curBalance;          // current balance
    String mBalance;            // string output for current balance
    String transaction;    // stored each transaction
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.commit();
                // Print history of transactions on UI
                history.setText(pref.getString("history", ""));
            }
        });
        ...
        minus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                curBalance -= spend;            // subtract money from current balance
                editor.putFloat("balance", (float) curBalance);
                editor.commit();
